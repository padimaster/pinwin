...
function ChatLine(message:any) {
  ...
  const positionClass = role === 'user' ? 'col-start-2 col-end-13' : 'col-start-1 col-end-12'
  ...
  return (
    <div className={`${positionClass} p-1 rounded-lg `} id={id}>
      <div className={`flex items-start justify-start ${flowClass}`}>
        <div
          className="flex items-center justify-center h-7 w-7 md:h-10 md:w-10 flex-shrink-0"
        >
          <Image
